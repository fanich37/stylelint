...
const fs = require('fs');
const handleCliError = require('./handleCliError');
...
// 1. TODO Need to check how creating config file realised in eslint.
// 2. TODO Separate one function into several each of them does one thing.
